...
TMUX_POWERLINE_SEPARATOR_LEFT_BOLD=$'\xee\x82\xb2'   # U+E0B2  left-pointing triangle
TMUX_POWERLINE_SEPARATOR_LEFT_THIN=$'\xee\x82\xb3'   # U+E0B3  thin left arrow
TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD=$'\xee\x82\xb0'  # U+E0B0  right-pointing triangle
TMUX_POWERLINE_SEPARATOR_RIGHT_THIN=$'\xee\x82\xb1'  # U+E0B1  thin right arrow
