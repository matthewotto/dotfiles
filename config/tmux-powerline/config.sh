...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="base16-ocean"
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/mattotto/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/mattotto/.mailcheckrc"
# }
...
# mode_indicator.sh {
	...
	export TMUX_POWERLINE_SEG_MODE_INDICATOR_COPY_MODE_TEXT_COLOR="" # Suspend mode text & color overrides. Defaults to "SUSPEND" & the segment foreground color set in the theme used.
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/mattotto/.now_playing.log"
...
# tmux_continuum_save.sh {
	...
	export TMUX_POWERLINE_SEG_TMUX_CONTINUUM_PATH="/Users/mattotto/.tmux/plugins//tmux-continuum"
# }
